    ...
    //tìm số records
    $result = DataProvider::executeQuery("SELECT count(MACL) AS total FROM sanpham WHERE TENSP LIKE  '%".$price."%' " . $condition);
    ...
    $sql = "SELECT * FROM sanpham WHERE TENSP LIKE  '%".$price."%' "  . $condition . " LIMIT $start, $limit";
